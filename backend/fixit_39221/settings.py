"""
Django settings for fixit_39221 project.
...
WSGI_APPLICATION = 'fixit_39221.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fixit_39221 API",
    "DESCRIPTION": "API documentation for fixit_39221 App",
    "VERSION": "v1",
}
